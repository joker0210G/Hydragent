        ...
        match crate::dream::run_dream_cycle(self.store.clone(), self.model_router.clone(), None).await {
            Ok(stats) => JsonRpcResponse {
                ...
                result: Some(serde_json::json!({
                    ...
                    "pages_clustered": stats.pages_clustered,
                    "books_organized": stats.books_organized,
                    "local_graphify_ops": stats.local_graphify_ops,
                    "compactions_user_md": stats.compactions_user_md,
                    "compactions_soul_md": stats.compactions_soul_md,
                    "extraction_failures": stats.extraction_failures,
                    "extraction_retries": stats.extraction_retries,
                    "dedup_hits": stats.dedup_hits,
                    "pages_skipped_trivial": stats.pages_skipped_trivial,
                    "facts_inferred": stats.facts_inferred,
                    "facts_verbatim": stats.facts_verbatim,
